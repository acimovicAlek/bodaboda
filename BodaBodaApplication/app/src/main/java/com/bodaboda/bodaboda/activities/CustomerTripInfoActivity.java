...
import static com.bodaboda.bodaboda.utils.Constants.PUBNUB_CHANNEL_NAME;

public class CustomerTripInfoActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_customer_trip_info);

        mMapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.customer_info_map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MainActivity.pubnub.addListener(new SubscribeCallback() {
            ...
            public void message(PubNub pub, final PNMessageResult message) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        try {
                            Map<String, String> newLocation = mapper.readValue(message.getMessage().toString(), LinkedHashMap.class);
        ...
        MainActivity.pubnub.subscribe()
                .channels(Arrays.asList(PUBNUB_CHANNEL_NAME)) // subscribe to channels
                .execute();
        System.out.println("Subscribed to " + PUBNUB_CHANNEL_NAME);
    ...
    private void updateUI(Map<String, String> newLoc) {
        ...
        if (driverMarker != null) {
            ...
            driverMarker = mGoogleMap.addMarker(new MarkerOptions().position(newLocation).
                    icon(BitmapDescriptorFactory.fromResource(R.drawable.baseline_motorcycle_black_18dp)));
        }
    }
